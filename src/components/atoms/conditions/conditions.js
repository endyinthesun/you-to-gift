...
export default function Conditions({
  ...
  const hashtags = additionally ? additionally.match(/#[\wа-яёА-ЯЁ]+/gm) : null;
    ...
    <View style={styles.container}>
        ...
        <View style={styles.topWarning}>
          <View style={styles.warningTitle}>
            <View style={styles.warningTitleLeft}>
              ...
              <Text style={styles.warningTitleText}>{t('attention')}</Text>
            </View>
          </View>
          <View>
      ...
      <View style={styles.conditionsContainer}>
        ...
        <View style={styles.bottomWarning}>
          ...
          <Text style={styles.warningText}>{t('to_participate_you_must')}</Text>
        </View>
      </View>
    </View>
  );
